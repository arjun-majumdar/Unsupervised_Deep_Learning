...
https://github.com/Lance0218/Pytorch-DistributedDataParallel-Training-Tricks/tree/master
"""
...
def main(
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for batch_idx, (images, labels) in enumerate(train_loader):
            ...
            if step < boundaries[0]:
                optimizer.param_groups[0]['lr'] = custom_lr_scheduler.get_lr(step) * world_size
                # optimizer.param_groups[0]['lr'] = custom_lr_scheduler.get_lr(step) / world_size
            else:
            ...
            optimizer.param_groups[0]['lr'] = scheduler(epoch) * world_size
        ...
        if rank == 0:
            ...
            if test_acc.item() > best_test_acc:
                ...
                torch.save(model.module.state_dict(), "ResNet18_CIFAR10_multigpu-best_testacc.pth")
    ...
    if rank == 0:
        ...
        with open("ResNet18_CIFAR10_train_history_lrscheduler.pkl", "wb") as file:
